...
<%@ page import="java.sql.*,java.io.*,com.db.DBConnection,com.bean.user" %>
   <jsp:useBean id="sum" scope="session" class="com.bean.user">
      <jsp:getProperty name="sum" property="a" />
       <jsp:getProperty name="sum" property="b" />
   </jsp:useBean>
...
<body>
    <center>
    <form method="post" action="ChangePassword.jsp" name="form1" onsubmit="return validate(this)">
...
conn=db.getConnection();
            stmt=conn.prepareStatement("UPDATE login SET pwd=? where uname=?");
