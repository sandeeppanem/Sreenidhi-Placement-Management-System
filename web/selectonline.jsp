...
<body background="backgrnd[2].gif">
    <center>
        <form name="main" method='post' action="save1.jsp">
    ...
    <tr> <td align="center"><input type='text' name='date' size=40 maxlength=200 value=""/></td></tr>
        ...
        <br><br>
       <input type="button" value="add" onclick="addrow('tbl1body')"><br><br>
      ENTER COMPANY NAME:<input type="text" name="company"><br>
